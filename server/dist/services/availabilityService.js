 ...
 */
function getMaxBookingDate(clientTier) {
 ...
 */
async function getAvailableSlots(date, serviceId, clientTier) {
    ...
    const workingHours = await prisma_js_1.prisma.workingHours.findUnique({
    ...
    const [appointments, blockedSlots] = await Promise.all([
        prisma_js_1.prisma.appointment.findMany({
            where: {
                staffId,
        ...
        prisma_js_1.prisma.blockedSlot.findMany({
            where: {
                staffId,
